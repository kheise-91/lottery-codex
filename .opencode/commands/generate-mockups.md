...
Produce $2 mockup variants for sub-phase $1 of ROADMAP.md. If $2 is empty, produce 3. Refer to @AGENTS.md for the project's design tokens and the mockup directory.
