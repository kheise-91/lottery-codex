...
2. **QA Validation via Playwright MCP**: You MUST use the Playwright MCP Server to:
...
4. **Validate with the Playwright MCP Server**:
   - Navigate to the dev server (https://dev-server.heise.home) using the Playwright MCP Server
