...
- Check for a saved issue plan in `.qwen/plans/` based on the issue number from Gitea. For example, if working on issue #12, check for `.qwen/plans/issue-12.md`. If a plan exists, pass it to every engineer subagent invoked,
