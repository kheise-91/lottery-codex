...
| [useMinLoading](./useMinLoading.md) | `frontend/src/hooks/useMinLoading.js` | Implemented | Wraps a raw boolean loading flag with a minimum visible duration (default 2000ms) so skeleton loaders don't flash on fast networks |
