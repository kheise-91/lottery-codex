...
## Workflow
1. **Read docs**: Before adding/modifying components, read `docs/components/README.md` and any relevant individual component docs. Before hook work, read `docs/hooks/README.md`. Before API service changes, read `docs/services/README.md`. Before API work, read `docs/api/README.md`. Before context work, read `docs/contexts/README.md`.
